...
export class WorkspaceRegistry extends Service {
  ...
  /**
   * Remove one session from the registry-global archive set. Its workspace
   * accounting slot is untouched, so it reappears where it was. An id that
   * is not archived resolves without writing.
   * @param sessionId - The session to restore into every grouping surface.
   * @returns resolution after durability.
   */
