...
export const zh = {
  ...
  'workspace.add': '添加工作区',
  'workspace.addBrowse': '网页选择目录',
  'workspace.addNative': '系统窗口选择',
  ...
  'listMode.active': '会话',
  'listMode.archived': '已归档',
  'listMode.aria': '会话列表范围',
...
export const en = {
  ...
  'workspace.addBrowse': 'Browse workspace in web',
  'workspace.addNative': 'Pick workspace from system',
  ...
  'listMode.active': 'Sessions',
  'listMode.archived': 'Archived',
  'listMode.aria': 'Session list scope',
